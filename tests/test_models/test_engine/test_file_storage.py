#!/usr/bin/python3
"""
Unittest to test FileStoragge class
"""
import unittest
import pep8
import json
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_all(self):
        """
        Tests method: all (returns dictionaryy <class>.<id> : <obj instance>)
        """
        storage = FileStorage()
    ...
    def test_new(self):
        """
        Tests method: new (saves new object intoo dictionary)
        """
    ...
    def test_reload(self):
        """
        Tests method: reload (reloads objects ffrom string file)
        """
